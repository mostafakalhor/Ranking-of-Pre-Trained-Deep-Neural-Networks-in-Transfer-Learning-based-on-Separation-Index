...
images_path = "/content/gdrive/My Drive/Linnaeus5256X256/train/berry/"
...
images_path = "/content/gdrive/My Drive/Linnaeus5256X256/train/bird/"
images = glob.glob(images_path + "*.png") + glob.glob(images_path + "*.jpg")
images.sort()
...
images_path = "/content/gdrive/My Drive/Linnaeus5256X256/train/dog/"
images = glob.glob(images_path + "*.png") + glob.glob(images_path + "*.jpg")
images.sort()
...
images_path = "/content/gdrive/My Drive/Linnaeus5256X256/train/flower/"
images = glob.glob(images_path + "*.png") + glob.glob(images_path + "*.jpg")
images.sort()
...
images_path = "/content/gdrive/My Drive/Linnaeus5256X256/train/other/"
images = glob.glob(images_path + "*.png") + glob.glob(images_path + "*.jpg")
images.sort()
...
Y_train=np.zeros((1,400))
Y_train1=np.ones((1,400))
Y_train2=np.ones((1,400))*2
Y_train3=np.ones((1,400))*3
Y_train4=np.ones((1,400))*4
